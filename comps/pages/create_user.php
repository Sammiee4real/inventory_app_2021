                ...
                <div class="col-12 col-xl-12">
                    <div class="card card-body bg-white border-light shadow-sm mb-4">
                        ...
                        <form method="post" id="create_user_form">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <div class="form-group">
                                        <label for="address">Password</label>
                                        <input class="form-control" id="passwordc" name="passwordc" type="password" placeholder="Enter Password again" required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-9 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="privilege_level" name="privilege_level">
                                            <option value=""></option>
                            ...
                            <div class="mt-3">
                                <input type="submit" id="cmd_user" name="cmd_user" class="btn btn-primary" value="Create User Now">
                            </div>
                        </form>
                    </div>
                </div>
